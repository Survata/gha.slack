...
const util_1 = __nccwpck_require__(5713);
const commander_1 = __nccwpck_require__(8909);
const slack_1 = __nccwpck_require__(6373);
...
async function post(token, data) {
    try {
        const res = await axios_1.default.post('https://slack.com/api/chat.postMessage', data, {
            headers: {
...
var transitionalDefaults = __nccwpck_require__(4491);
var AxiosError = __nccwpck_require__(1914);
var CanceledError = __nccwpck_require__(9862);
...
var AxiosError = __nccwpck_require__(1914);
var CanceledError = __nccwpck_require__(9862);
var parseProtocol = __nccwpck_require__(3863);
...
var defaults = __nccwpck_require__(9953);
...
axios.CanceledError = __nccwpck_require__(9862);
...
axios.toFormData = __nccwpck_require__(7781);

// Expose AxiosError class
axios.AxiosError = __nccwpck_require__(1914);
...
module.exports = __nccwpck_require__(6454);
...
var AxiosError = __nccwpck_require__(1914);
var transitionalDefaults = __nccwpck_require__(4491);
var toFormData = __nccwpck_require__(7781);
...
var defaults = {
  ...
  env: {
    FormData: __nccwpck_require__(231)
  },
...
const { Help } = __nccwpck_require__(9754);
const { Option, splitOptionFlags, DualOptions } = __nccwpck_require__(5240);
