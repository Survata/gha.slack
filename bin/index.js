...
const Canvas = __nccwpck_require__(2059)
const Image = __nccwpck_require__(2122)
const CanvasRenderingContext2D = __nccwpck_require__(979)
const CanvasPattern = __nccwpck_require__(3915)
const parseFont = __nccwpck_require__(8906)
const packageJson = __nccwpck_require__(8392)
const bindings = __nccwpck_require__(9192)
const fs = __nccwpck_require__(7147)
const PNGStream = __nccwpck_require__(8357)
const PDFStream = __nccwpck_require__(2716)
const JPEGStream = __nccwpck_require__(4812)
const { DOMPoint, DOMMatrix } = __nccwpck_require__(7029)
...
__webpack_unused_export__ = Canvas
__webpack_unused_export__ = CanvasRenderingContext2D // Legacy/compat export
__webpack_unused_export__ = CanvasRenderingContext2D
__webpack_unused_export__ = bindings.CanvasGradient
__webpack_unused_export__ = CanvasPattern
__webpack_unused_export__ = Image
__webpack_unused_export__ = bindings.ImageData
__webpack_unused_export__ = PNGStream
__webpack_unused_export__ = PDFStream
__webpack_unused_export__ = JPEGStream
__webpack_unused_export__ = DOMMatrix
__webpack_unused_export__ = DOMPoint

exports.Qx = registerFont
__webpack_unused_export__ = deregisterAllFonts
__webpack_unused_export__ = parseFont

exports.vL = createCanvas
__webpack_unused_export__ = createImageData
__webpack_unused_export__ = loadImage

__webpack_unused_export__ = bindings.Backends

/** Library version. */
__webpack_unused_export__ = packageJson.version
/** Cairo version. */
__webpack_unused_export__ = bindings.cairoVersion
/** jpeglib version. */
__webpack_unused_export__ = bindings.jpegVersion
/** gif_lib version. */
__webpack_unused_export__ = bindings.gifVersion ? bindings.gifVersion.replace(/[^.\d]/g, '') : undefined
/** freetype version. */
__webpack_unused_export__ = bindings.freetypeVersion
/** rsvg version. */
__webpack_unused_export__ = bindings.rsvgVersion
...
const bindings = __nccwpck_require__(9945)
...
const Context2d = __nccwpck_require__(979)
const PNGStream = __nccwpck_require__(8357)
const PDFStream = __nccwpck_require__(2716)
const JPEGStream = __nccwpck_require__(4812)
...
const bindings = __nccwpck_require__(9192)
const parseFont = __nccwpck_require__(8906)
const { DOMMatrix } = __nccwpck_require__(7029)
  ...
  set (val) {
    if (typeof val === 'string') {
      if (/^\s*data:/.test(val)) { // data: URI
        ...
        if (!get) get = __nccwpck_require__(4438)
...
const concat = __nccwpck_require__(6150)
const decompressResponse = __nccwpck_require__(8995) // excluded from browser build
...
module.exports = eval("require")("./s3Client");
...
const { Argument } = __nccwpck_require__(7856);
const { Command } = __nccwpck_require__(3340);
const { CommanderError, InvalidArgumentError } = __nccwpck_require__(2297);
const { Help } = __nccwpck_require__(8193);
const { Option } = __nccwpck_require__(4224);
...
const { InvalidArgumentError } = __nccwpck_require__(2297);
...
const { Argument, humanReadableArgName } = __nccwpck_require__(7856);
const { CommanderError } = __nccwpck_require__(2297);
const { Help } = __nccwpck_require__(8193);
const { Option, splitOptionFlags, DualOptions } = __nccwpck_require__(4224);
const { suggestSimilar } = __nccwpck_require__(1469);
...
const { humanReadableArgName } = __nccwpck_require__(7856);
...
// EXTERNAL MODULE: ./node_modules/canvas/index.js
var node_modules_canvas = __nccwpck_require__(6233);
// EXTERNAL MODULE: ../../../../usr/local/lib/node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./s3Client
var _notfounds3Client = __nccwpck_require__(4003);
;// CONCATENATED MODULE: ./dist/iconCreator.js



var iconCreator;
(function (iconCreator) {
    async function conditionallyCreate(name) {
        console.log('checking image', name);
        const imageExists = await _notfounds3Client.s3Client.checkIfExists(name);
        if (!imageExists) {
            console.log('creating image', name);
            await create(name);
        }
    }
    iconCreator.conditionallyCreate = conditionallyCreate;
    async function create(name) {
        (0,node_modules_canvas/* registerFont */.Qx)('src/Inter-Medium.ttf', { family: 'Inter' });
        ...
        const size = 192;
        const canvas = (0,node_modules_canvas/* createCanvas */.vL)(size, size);
        ...
        ctx.fillText(shortName, 5, 155, 185);
        try {
            const canvasData = await canvas.toBuffer('image/png');
            await _notfounds3Client.s3Client.save(name, canvasData);
        }
        catch (e) {
            console.log(e);
